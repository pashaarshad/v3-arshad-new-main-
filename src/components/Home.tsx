          ...
          <div className="text-center lg:text-left">
            ...
            <div ref={socialRef} className="flex justify-center lg:justify-start gap-4 mb-8 flex-wrap">
              ...
              <a
                ...
                className="text-text-tertiary hover:text-[#0077b5] transition-all duration-300 transform hover:scale-110"
                aria-label="LinkedIn"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-text-tertiary hover:text-[#25D366] transition-all duration-300 transform hover:scale-110"
                aria-label="WhatsApp"
              >
                <svg className="w-10 h-10 sm:w-12 sm:h-12" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-text-tertiary hover:text-[#E4405F] transition-all duration-300 transform hover:scale-110"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-text-tertiary hover:text-accent-secondary transition-all duration-300 transform hover:scale-110"
                aria-label="Resume"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-text-tertiary hover:text-[#333] dark:hover:text-white transition-all duration-300 transform hover:scale-110"
                aria-label="GitHub"
              >
                <svg className="w-10 h-10 sm:w-12 sm:h-12" fill="currentColor" viewBox="0 0 24 24">
