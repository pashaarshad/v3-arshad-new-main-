          ...
          <div className="bg-card-bg backdrop-blur-sm border border-card-border p-6 sm:p-8 md:p-10 rounded-xl shadow-2xl">
            <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-accent-primary to-blue-700 text-white py-3 sm:py-3.5 rounded-lg font-semibold hover:from-accent-hover hover:to-blue-800 transition-all duration-300 transform hover:scale-[1.02] text-sm sm:text-base shadow-lg hover:shadow-accent-primary/50 disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center gap-2"
              >
                {isSubmitting ? (
                  <>
